...
use crate::player::{get_alive_players, Player};
...
pub fn royal_rumbel() {
    ...
    loop {
        ...
        let user_a_atk = get_alive_players(users_a);
        let user_a_def = get_alive_players(users_a);
        let user_b_atk = get_alive_players(users_b);
        let user_b_def = get_alive_players(users_b);
